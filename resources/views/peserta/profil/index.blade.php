                ...
                <div class="card-body">
                    ...
                    <div id="btnwizard">
                        ...
                        <div class="tab-content mb-0 b-0">
                                            ...
                                            <div class="col-md-9">
                                                <div class="mb-3 position-relative" id="datepicker4">
                                                    <input type="text" id="tgl_lahir" name="tgl_lahir"
                                                        ...
                                                        value="{{ $profils[0]->tgl_lahir }}" disabled>
                                                    <div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <input type="radio" id="customRadio3" name="jk"
                                                        class="form-check-input" checked>
                                                    <label class="form-check-label" for="customRadio3">Perempuan</label>
                                                    @endif
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <textarea name="alamat" data-toggle="maxlength" class="form-control"
                                                    ...
                                                    disabled>{{ $profils[0]->alamat }}</textarea>
                                            </div>
                                        </div>
                                    </div> <!-- end col -->
                                </div> <!-- end row -->
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="name3" name="karpeg" class="form-control"
                                                    value="{{ $profils[0]->karpeg }}" disabled>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="name3" name="karpeg" class="form-control"
                                                    value="{{ $profils[0]->golongan }}" disabled>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="name3" name="karpeg" class="form-control"
                                                    value="{{ $profils[0]->jabatan }}" disabled>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="name3" name="karpeg" class="form-control"
                                                    value="{{ $profils[0]->jenjang_jabatan }}" disabled>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="name3" name="karpeg" class="form-control"
                                                    value="{{ $profils[0]->jenjang_tingkat_jabatan }}" disabled>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <div class="mb-3 position-relative" id="datepicker3">
                                                    <input type="text" class="form-control" data-provide="datepicker"
                                                        ...
                                                        name="tmt_pangkat" value="{{ $profils[0]->tmt_pangkat }}"
                                                        disabled>
                                                </div>
                                            ...
                                            <div class="col-md-9">
                                                <div class="mb-3 position-relative" id="datepicker2">
                                                    <input type="text" class="form-control" data-provide="datepicker"
                                                        ...
                                                        name="tmt_jabatan" value="{{ $profils[0]->tmt_jabatan }}"
                                                        disabled>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="input-group mb-3 position-relative"
                                                            ...
                                                            <input type="text" class="form-control"
                                                                value="{{ $profils[0]->mk_bulan_lama }}" disabled>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group mb-3 position-relative"
                                                            id="datepicker6">
                                                            <input type="text" class="form-control"
                                                                value="{{ $profils[0]->mk_tahun_lama }}" disabled>
                                                            <span class="input-group-text"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="input-group mb-3 position-relative"
                                                            id="datepicker5">
                                                            <input type="text" class="form-control"
                                                                value="{{ $profils[0]->mk_bulan_baru }}" disabled>
                                                            <span class="input-group-text"
                                                                id="basic-addon2">Bulan</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="input-group mb-3 position-relative"
                                                            id="datepicker6">
                                                            <input type="text" class="form-control"
                                                                value="{{ $profils[0]->mk_tahun_baru }}" disabled>
                                                            <span class="input-group-text"
                                                                id="basic-addon2">Tahun</span>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-5 mb-2">
                                                <input type="text" class="form-control"
                                                    value="{{ $profils[0]->unit_kerja }}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end col -->
                            ...
                            <div class="float-end">
                                <input type='button' class='btn btn-info button-previous' name='previous' value='Prev'>
                                <input type='button' id="next-button" class='btn btn-info button-next' name='next'
                                    value='Next'>
                            </div>
                            <div class="float-start">
                                <a href="{{ route('peserta.edit.profil', ['id' => Auth::id()]) }}" role="button"
