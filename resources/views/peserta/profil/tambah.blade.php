                    ...
                    <div class="card-body">
                        ...
                        <div id="btnwizard">
                            ...
                            <div class="tab-content mb-0 b-0">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" id="t_lahir" class="form-control" id="userName3" name="t_lahir" required="">
                                                    <div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="mb-3 position-relative" id="datepicker4">
                                                        <input type="text" id="tgl_lahir" class="form-control" data-provide="datepicker" data-date-autoclose="true" data-date-container="#datepicker4">
                                                        <div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea data-toggle="maxlength" class="form-control" maxlength="225" rows="3"></textarea>
                                                </div>
                                            </div>
                                            
                                            <div class="row mb-3">
                                                <label class="col-md-3 col-form-label" class="new-button3" for="example-fileinput">Upload KTP</label>
                                                <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" id="name3" name="nip" class="form-control" required="">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label class="col-md-3 col-form-label" for="name3"> Karpeg </label>
                                                <div class="col-md-9">
                                                    <input type="text" id="name3" name="karpeg" class="form-control" required="">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                <label class="col-md-3 col-form-label" for="name3"> Jenjang Tingkat Jabatan </label>
                                                <div class="col-md-9">
                                                    <select class="form-control select2" data-toggle="select2">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="mb-3 position-relative" id="datepicker3">
                                                        <input type="text" class="form-control" data-provide="datepicker" data-date-autoclose="true" data-date-container="#datepicker3">
                                                    </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="mb-3 position-relative" id="datepicker2">
                                                        <input type="text" class="form-control" data-provide="datepicker" data-date-autoclose="true" data-date-container="#datepicker2">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-5 mb-2">
                                                    ...
                                                    <div class="mt-2" id="show_kerja" style="display: none">
                                                        <input type="text" id="name3" name="karpeg" class="form-control" required="" placeholder="Tulis unit kerja lainnya">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <p>Unit kerja lainnya : <button type="button" class="btn btn-success btn-sm" id="pilih_kerja">Pilih</button></p>
                                                </div>
                                ...
                                <div class="float-end">
                                    <input type='button' id="next-button" class='btn btn-info button-next' name='next' value='Next'>
                                    <input type='button' id="last-button" class='btn btn-info button-last' name='last' value='Last'>
                                </div>
